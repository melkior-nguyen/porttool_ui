...
const CreateMonitor = ({
  farm,
  openCreateMonitor,
  handleCloseCreateMonitor,
}: {
  farm: any;
  openCreateMonitor: boolean;
  handleCloseCreateMonitor: () => void;
}) => {
    ...
    (userInfoMonitor: any, isNewForm?: typeof formData) => {
      if (userInfoMonitor) {
        ...
        setFormData((formData) => {
          const cloneFormData = clone(isNewForm ?? formData);
          cloneFormData.fields.map((field) => {
            ...
            if (field.name === "method") {
              ...
              if (cloneFormData.initialValues && field.options)
          ...
          if (typeMonitorField) typeMonitorField.disabled = false;
  ...
  const handleSubmit = useCallback(
    ...
    [formData, dispatchResolve, handleCloseCreateMonitor, farm, params]
  );
